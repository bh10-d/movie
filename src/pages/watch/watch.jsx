            ...
            <div className="relative">
                <div className="lg:container">
                    <div className="md:flex overflow-hidden">
                        <div className="basis-full w-full lg:basis-9/12 lg:mr-5">
                            {/* <Video data={movie} episode={e} first={`${(e==undefined)?episode:e}`} subtitle={subtitle}/> */}
                            <div className="h-[330px] md:h-[550px] w-screen lg:w-full">
                        ...
                        <div className="basis-0 lg:basis-3/12 invisible lg:visible">
                            <div>
